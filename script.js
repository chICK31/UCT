...
function displayResults(results, gender, octagram, mbtiTypeArray, universalCompatibilityFunction, newStart, primaryFunctionGender) {
...
function processForm() {
    ...
    if (!results || Object.keys(results).length === 0) {
        ...
        displayResults(results, genderResult, octagramResult, mbtiTypeArray, universalCompatibilityFunction, newStart, primaryFunctionGender);
    }
}
    // Display results
    const resultsDiv = document.getElementById('results');
...
function getType(gender, octagram, mbtiTypeKey, sortingPreference) {
    ...
    return {
        ...
        gender: gender,
        octagram: octagram,
        mbtiTypeArray: mbtiTypeArray,
        universalCompatibilityFunction: universalCompatibilityFunction,
        newStart: newStart,
